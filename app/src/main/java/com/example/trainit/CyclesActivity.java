...
public class CyclesActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textViewProblem = findViewById(R.id.tv_problem_cyc);
        btnAnswer1 = findViewById(R.id.btn_answer1_cyc);
        btnAnswer2 = findViewById(R.id.btn_answer2_cyc);
        btnAnswer3 = findViewById(R.id.btn_answer3_cyc);
        btnAnswer4 = findViewById(R.id.btn_answer4_cyc);
        ...
        btnAnswer1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(curProblem < problemItems.size()-1){
                    ...
                    Intent intent = new Intent(CyclesActivity.this, EndActivity.class);
    ...
    private void loadAllProblems(){
        ...
        String jsonStr = loadJSONFromAsset("CyclesProblems.json");

        try{
            JSONObject jsonObj = new JSONObject(jsonStr);
            JSONArray problems = jsonObj.getJSONArray("cycles");
    ...
    public String loadJSONFromAsset(String file) {
        String json = "";
        try {
            InputStream is = getAssets().open("CyclesProblems.json");
